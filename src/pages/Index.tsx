  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 bg-primary text-white p-4 rounded-full shadow-lg hover:bg-primary/90 transition-all hover:scale-110 z-50 animate-fade-in"
          aria-label="Наверх"
        >
